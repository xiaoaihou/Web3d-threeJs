...
export default [
  createConfig('es', { file: 'build/web3d.module.cdn.js' }, [replace(cdnReplaces)]),
  createConfig('es', { file: 'build/web3d.module.cdn.min.js' }, [replace(cdnReplaces)], true),
  createConfig('es', { file: 'build/web3d.module.js' }),
  createConfig('es', { file: 'build/web3d.module.min.js' }, [], true),
  createConfig('cjs', { file: 'build/web3d.js' }),
  {
