...
<template>
  <div id="container">
      ...
      <Scene :background="background">
        ...
        <GltfModel ref="box" @onLoad="onLoad" src="src/characterModels/gltf/charman4/scene.gltf" />
      </Scene>
    </Renderer>
  </div>
</template>
...
export default defineComponent({
  ...
  mounted() {
    ...
    this.renderer.onBeforeRender(() => {
      this.animate()
      if (this.model.scene) {
        this.model.scene.scale.x = 0.075
        this.model.scene.scale.y = 0.075
        this.model.scene.scale.z = 0.075
      }
    })
  },
  methods: {
    ...
    animate() {
      ...
      if (this.controls.dance) this.fadeToAction('mixamo.com', 0.5)
    },
