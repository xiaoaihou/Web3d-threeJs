...
<template>
  <div id="container">
      ...
      <Scene :background="background">
        ...
        <GltfModel ref="box" @onLoad="onLoad" src="src/characterModels/gltf/charman6/scene.gltf" />
      </Scene>
    </Renderer>
  </div>
</template>
...
export default defineComponent({
  ...
  data() {
    return {
      actionsControls: [
        { type: 'Standing', name: '翻手机' },
        { type: 'Walking', name: '走路' },
        { type: 'Idle', name: '摆拍' },
        { type: 'Texting', name: '低头走' },
      ],
      animations: {},
      activeAction: null,
      previousAction: null,
  ...
  methods: {
    ...
    animate() {
      ...
      if (this.controls.Standing) this.fadeToAction('Standing Using Touchscreen Tablet', 0.5)
      if (this.controls.Walking) this.fadeToAction('Walking', 0.5)
      if (this.controls.Idle) this.fadeToAction('Neutral Idle', 0.5)
      if (this.controls.Texting) this.fadeToAction('Texting And Walking', 0.5)
    },
